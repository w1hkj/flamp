...
/** ********************************************************
 * \brief Open an AX.25 connection
 * \param iface	Interface
 * \param local		Local address
 * \param remote	Remote address
 * \param mode		active/passive/server
 * \param window	Window size in bytes
 * \param r_upcall	Receiver upcall handler
 * \param t_upcall	Transmitter upcall handler
 * \param s_upcall	State-change upcall handler
 * \param user	    User linkage area
 ***********************************************************/
struct ax25_cb * open_ax25(struct iface *iface, char *local, char *remote,
	int mode, uint16 window, void (*r_upcall)(), void (*t_upcall)(),
	void (*s_upcall)(), int user)
{
	struct ax25_cb *axp;
	char remtmp[AXALEN];
...
/** ********************************************************
 * \brief Send data on an AX.25 connection. Caller provides optional PID. If
...
/** ********************************************************
 * \brief Receive incoming data on an AX.25 connection
 ***********************************************************/
...
/** ********************************************************
 * \brief Close an AX.25 connection
 ***********************************************************/
...
/** ********************************************************
 * \brief Verify that axp points to a valid ax25 control block
 ***********************************************************/
...
/** ********************************************************
 * \brief Abruptly terminate an AX.25 connection
 ***********************************************************/
