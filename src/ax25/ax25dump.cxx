...
/** ********************************************************
 * \brief Dump an AX.25 packet header
 ***********************************************************/
...
/** ********************************************************
 * \brief Return 1 if this packet is directed to us, 0 
 * otherwise. Note that this checks only the ultimate 
 * destination, not the digipeater field
 ***********************************************************/
