...
/** ********************************************************
 * \brief Function that handles incoming UI frames from lapb.c
 ***********************************************************/
 ...
 *
 ***********************************************************/
int so_ax_recv(struct usock *up, struct mbuf **bpp, char *from, int *fromlen)
{
	struct ax25_cb *ax25;
	int cnt;
 ...
 *
 ***********************************************************/
int so_axui_recv(struct usock *up,struct mbuf **bpp,char *from,int *fromlen)
{
	int s;
...
/** ********************************************************
 * \brief AX25 state change upcall routine
 ***********************************************************/
...
/** ********************************************************
 * \brief Issue an automatic bind of a local AX25 address
 ***********************************************************/
static void autobind(struct usock *up)
{
	struct sockaddr_ax local;
