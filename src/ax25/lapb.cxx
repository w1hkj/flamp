...
/** ********************************************************
 * \brief Process incoming frames
 * \param *axp	Link control structure (struct ax25_cb)
 * \param cmdrsp Command/response flag
 * \param bp Rest of frame, starting with ctl struct mbuf
 ***********************************************************/
...
/** ********************************************************
 * \brief Handle incoming acknowledgements for frames we've sent.
...
/** ********************************************************
 * \brief Clear exception conditions
 ***********************************************************/
static void clr_ex(struct ax25_cb *axp)
{
	axp->flags.remotebusy = NO;
...
/** ********************************************************
 * \brief Send S or U frame to currently connected station
 ***********************************************************/
...
/** ********************************************************
 * \briefStart data transmission on link, if possible
...
/** ********************************************************
 * \brief Process a valid incoming I frame
 ***********************************************************/
static void procdata(struct ax25_cb *axp,struct mbuf *bp)
{
	int pid;
...
/** ********************************************************
 * \brief New-style frame segmenter. Returns queue of 
 * segmented fragments, or original packet if small enough
 ***********************************************************/
