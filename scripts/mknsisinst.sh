...
fm_msngr_name=fm_msngr
fm_msngr_bin=fm_msngr.exe
...
test "x$NOSTRIP" = "x" && $STRIP -S "$fm_msngr_bin"
def="-Dfm_msngr_NAME=$fm_msngr_name -Dfm_msngr_BINARY=$fm_msngr_bin -Dfm_msngr_VERSION=$PACKAGE_VERSION"
