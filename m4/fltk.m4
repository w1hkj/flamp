AC_DEFUN([AC_CHECK_FLTK], [
  ...
  *** contains fltk-config.
      ...
      FLLNK_FLTK_API_MAJOR=${FLTK_VERSION%%.*}

      FLLNK_FLTK_API_MINOR=${FLTK_VERSION#*.};
      FLLNK_FLTK_API_MINOR=${FLLNK_FLTK_API_MINOR%%.*}

      FLLNK_FLTK_API_PATCH=${FLTK_VERSION#*.};
      FLLNK_FLTK_API_PATCH=${FLLNK_FLTK_API_PATCH#*.};
  ...
  *** To build $PACKAGE you need a FLTK version that provides API 1.1 or 1.3.
  ...
  AC_DEFINE_UNQUOTED([FLLNK_FLTK_API_MAJOR], [$FLLNK_FLTK_API_MAJOR], [FLTK API major version])
  AC_DEFINE_UNQUOTED([FLLNK_FLTK_API_MINOR], [$FLLNK_FLTK_API_MINOR], [FLTK API minor version])
  AC_DEFINE_UNQUOTED([FLLNK_FLTK_API_PATCH], [$FLLNK_FLTK_API_PATCH], [FLTK API patch])
