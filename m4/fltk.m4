AC_DEFUN([AC_CHECK_FLTK], [
  ...
  *** contains fltk-config.
      ...
      FM_MSNGR_FLTK_API_MAJOR=${FLTK_VERSION%%.*}

      FM_MSNGR_FLTK_API_MINOR=${FLTK_VERSION#*.};
      FM_MSNGR_FLTK_API_MINOR=${FM_MSNGR_FLTK_API_MINOR%%.*}

      FM_MSNGR_FLTK_API_PATCH=${FLTK_VERSION#*.};
      FM_MSNGR_FLTK_API_PATCH=${FM_MSNGR_FLTK_API_PATCH#*.};
  ...
  *** To build $PACKAGE you need a FLTK version that provides API 1.3.
  ...
  AC_DEFINE_UNQUOTED([FM_MSNGR_FLTK_API_MAJOR], [$FM_MSNGR_FLTK_API_MAJOR], [FLTK API major version])
  AC_DEFINE_UNQUOTED([FM_MSNGR_FLTK_API_MINOR], [$FM_MSNGR_FLTK_API_MINOR], [FLTK API minor version])
  AC_DEFINE_UNQUOTED([FM_MSNGR_FLTK_API_PATCH], [$FM_MSNGR_FLTK_API_PATCH], [FLTK API patch])
